...
### Phase 4 — Tauri menu-bar app (`readloop-desktop`)
...
### Phase 7 — Readwise connector for `crosspoint-sync` (`readloop-sync`)
...
- **`readloop-desktop`** — Tauri app (MIT).
- **Fork/PR to `crosspoint-sync`** — Readwise *connector* / `readloop-sync` (MIT).
